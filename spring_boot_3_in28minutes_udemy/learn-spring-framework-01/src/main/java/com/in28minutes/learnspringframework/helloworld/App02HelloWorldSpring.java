...
public class App02HelloWorldSpring {
    ...
    public static void main(String[] args) {
        ...
        try(var context = new AnnotationConfigApplicationContext(HelloWorldConfiguration.class)) {
            ...
            // 3. Retrieving Beans managed by Spring (Retrieving Beans from Spring Context)
            System.out.println(context.getBean("name"));
            System.out.println(context.getBean("age"));
            System.out.println(context.getBean("person"));
            System.out.println(context.getBean("person2MethodCall"));
            System.out.println(context.getBean("person3Parameters"));
            System.out.println(context.getBean("address2")); // using Bean name
            System.out.println(context.getBean(Person.class));
            System.out.println(context.getBean("person5ParametersQualifier"));
            System.out.println(context.getBean(Address.class)); // using Bean type
